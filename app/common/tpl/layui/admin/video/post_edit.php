    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-tab-content">
            <div class="layui-form layui-tab-item layui-show">
                <form class="content-form" method="post" action="<?=url('api/videoAdmin/post_edit')?>" style="min-height: 600px;overflow:hidden;" id="content_form" lay-filter="post">
                            ...
                            <div class="layui-tab-content">
                                ...
                                <div class="layui-tab-item">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input id="date_published" class="layui-input datetime-input2" type="text" name="date_published"  value="<?=date('Y-m-d',$data['date_published'])?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="layui-tab-item">
...
<script type="text/javascript">//向js传递的必要参数
    ...
    var currentData={
        ...
        isEdit:true, //是否是编辑页
        tagsEditUrl:"<?=url('api/videoAdmin/tags_edit')?>", //标签修改的url
        ueditor:"<?=url('admin/upload/ueditor')?>", //ueditor上传文件的接口
        sourceAddUrl:"<?=url('api/videoAdmin/source_add')?>",//资源
        sourceEditUrl:"<?=url('api/videoAdmin/source_edit')?>",
        sourceShowUrl:"<?=url('api/videoAdmin/source_show')?>?vid=<?=$data['id']?>",
        sourceDelUrl:"<?=url('api/videoAdmin/source_del')?>"
    };
</script>
{%end%}
