    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-tab-content">
            <div class="layui-form layui-tab-item layui-show">
                <form class="content-form" method="post" action="<?=url('api/videoAdmin/post_add')?>" style="min-height: 600px;overflow:hidden;" id="content_form" lay-filter="post">
                            ...
                            <div class="layui-tab-content">
                                ...
                                <div class="layui-tab-item">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input id="date_published" class="layui-input datetime-input2" type="text" name="date_published"  value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="layui-tab-item">
