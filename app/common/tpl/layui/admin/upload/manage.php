        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-form">
                <p style="font-size:13px;">
                    <a class="layui-btn" id="thumb-del" href="javascript:;" ac="<?=url('admin/apiUpload/thumb_del')?>">删除缩略图</a>
                    <a class="layui-btn" id="thumb-create" href="javascript:;" ac="<?=url('admin/apiUpload/thumb_create')?>">生成缩略图</a>&nbsp;&nbsp;
                </p>
                <form method="post" action="<?=url('admin/apiOther/links_multi_action')?>" name="form-main" id="form-main">
                    ...
                    <?php if(isset($data) && $data): foreach ($data as $item): ?>
                        <tr id="c<?=$item['id']?>">
                            ...
                            <td style="text-align: center;">
                                ...
                                <i class="layui-icon" style="font-size: 20px;">
                                    <a title="删除" id="deletea_<?=$item['id']?>" href="javascript:;" ac="<?=url('admin/apiOther/links_del')?>?id=<?=$item['id']?>">
                                        &#xe640;
                                    </a>
                                </i>
                            </td>
