    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-form">
                ...
                <form method="post" action="<?=url('admin/apiPortal/post_multi_action')?>?type=<?=$type?>" name="form2" id="form2">
                        ...
                        <?php /*dump($data);*/ if($data): $thumbFormat=getThumbFormat();foreach ($data as $item): ?>
                            <tr id="c<?=$item['id']?>">
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <i class="layui-icon" style="font-size: 20px;">
                                        <a title="删除" id="deletea_<?=$item['id']?>" href="javascript:;" ac="<?=url('admin/apiPortal/post_del')?>?type=<?=$type?>&id=<?=$item['id']?>">
                                            &#xe640;
                                        </a>
                                    </i>
                                    <i class="layui-icon" style="font-size: 20px;">
