        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-form">
                <p style="font-size:13px;">
                    ...
                    <a id="update-cache" class="layui-btn" href="javascript:;" ac="<?=url('admin/apiPortal/category_cache')?>?type=<?=$type?>" confirm="false">更新缓存</a>
                </p>

                <form method="post" action="<?=url('admin/apiPortal/category_multi_action')?>?type=<?=$type?>" name="form2" id="form2">
    ...
    <script type="text/javascript">
        layui.use(['layer','form','fly'], function() {
            ...
            $("a[id^='deletea']").on('click', function(){
                ...
                $(this).attr('ac',"<?=url('admin/apiPortal/category_del')?>?type="+currentData.type+'&id='+ac);
                fly.ajaxClick(this);
                return false;
            });
            //编辑一条
