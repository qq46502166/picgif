    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-tab-content">
            <div class="layui-form layui-tab-item layui-show">
                <form class="content-form" method="post" action="<?=url('admin/apiPortal/post_edit')?>?type=<?=$type?>" style="min-height: 600px;overflow:hidden;" id="content_form" lay-filter="post">
                            ...
                            <div class="layui-tab-content">
                                ...
                                <div class="layui-tab-item">
                                    <div class="layui-form-item">
                                        <label class="layui-form-label"></label>
                                        <div class="layui-input-block">
                                            <button type="button" class="layui-btn layui-btn-primary" id="juhe-parent-select" data="<?=url('admin/apiPortal/search_juhe')?>?type=<?=$type?>">添加上级</button>
                                    ...
                                    <div class="layui-form-item">
                                        <label class="layui-form-label"></label>
                                        <div class="layui-input-block">
                                            <p><button type="button" class="layui-btn layui-btn-primary" id="juhe-children-select" data="<?=url('admin/apiPortal/search_juhe')?>?type=<?=$type?>">添加下级</button></p>
                                            <ul class="juhe-container" id="juhe-children-container">
                                            </ul>
                                            <input id="children_id" type="hidden" name="children_id" value="">
                                            <?php if($children):?>
                                                <ul id="juhe-children-existing" data="<?=url('admin/apiPortal/del_pid')?>">
...
<script type="text/javascript">//向js传递的必要参数
    ...
    var currentData={
        ...
        isEdit:true, //是否是编辑页
        tagsEditUrl:"<?=url('admin/apiPortal/tags_edit')?>", //标签修改的url
