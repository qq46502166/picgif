            ...
            <div class="layui-tab-item layui-show">
                <form class="layui-form" name="form1" id="form1" method="get" action="" lay-filter="shaixuan">
                    <p>
                        ...
                        <a class="layui-btn" href="javascript:;" id="delete_end"  ac="<?=url('api/kamiAdmin/del_end')?>">删除完结卡</a>
                    </p>
...
<script type="text/javascript">
    layui.use(['layer','fly'],function () {
        ...
        $("#btn-sale").click(function () {
           ...
           fly.json("<?=url('api/kamiAdmin/type2sale')?>", {large_id:<?php $aa=end($data);echo $aa['id']?:0;?>,type:kami_type}, function (res) {
