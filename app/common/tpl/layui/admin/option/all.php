        ...
        <div class="layui-tab-content" style="padding: 20px 0;">
            <div class="layui-tab-item layui-show">
                <p style="font-size:13px;">
                    ...
                    <a id="update-cache" class="layui-btn" href="javascript:;" ac="<?=url('admin/apiOption/option_cache')?>?type=<?=$type?>" confirm="false">更新缓存</a>
                </p>

                <form class="layui-form" method="post" action="<?=url('admin/apiOption/option_all');?>?type=<?=$type?>" id="form-main">
                    <table class="layui-table">
                        ...
                        <?php foreach ($data as $k =>$v): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="layui-icon" title="删除" id="deletea_<?=$type.'_'.$v['name'];?>" href="javascript:;" ac="<?=url('admin/apiOption/option_del')?>?name=<?=$v['name']?>&type=<?=$type?>">
                                        &#xe640;
                                    </a>
                                </td>
                            </tr>
