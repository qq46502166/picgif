    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-form">
                ...
                <form method="post" action="<?=url('api/bbsAdmin/action_multi')?>?aa=" name="form2" id="form2">
                ...
                <form class="layui-form" method="post" action="<?=url('api/bbsAdmin/action_multi')?>?aa=" name="form-main" id="form-main">
                            ...
                            <tr id="c<?=$item['id']?>">
                                ...
                                <td style="text-align: center;">
                                    <i class="layui-icon" style="font-size: 20px;">
                                        <a title="修改" href="<?=url('api/bbsAdmin/edit',['id'=>$item['id']])?>">&#xe642;</a>
                                    </i>
                                    <i class="layui-icon" style="font-size: 20px;">
                                        <a title="删除" id="deletea_<?=$item['id']?>" href="javascript:;" ac="<?=url('api/bbsAdmin/del')?>?id=<?=$item['id']?>">
                                            &#xe640;
                                        </a>
                                    </i>
                                </td>
            ...
            $("a[id^='add-tag-").on('click', function(){
                ...
                layer.open({
                    ...
                    yes:function (index, layero) {
                        ...
                        fly.json("<?=url('api/bbsAdmin/quick_edit')?>",{id:id,title:newTitle,content:newContent,tag:tags,comment:layero.find("#layer-comment").val(),isend:isend,type:currentTp},function (res) {
                            layer.msg(res.msg);
