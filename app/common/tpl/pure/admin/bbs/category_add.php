...
{%block@main%}
<div class="path">
	<a href="<?=url('admin/index/index')?>">首页</a> &gt; 论坛管理 &gt; <a href="<?=url('admin/bbs/category')?>">分类管理</a> &gt; <?=$title?>
</div>
<div class="content">
							...
							<textarea id="description" name="description" class="pure-input-1-2"></textarea>
							 ...
							 <div class="tab-item" id="category-seo">
								...
								<label for="seo_description">SEO描述（最多255个字）</label>
								 <textarea class="pure-input-1-2" id="seo_description" type="text" name="seo_description" rows="3"></textarea>
							 ...
							 <div class="tab-item" id="category-tpl">
								...
								<label for="content_tpl">文章模板</label>
								<input class="pure-input-1-2" id="content_tpl" type="text" name="content_tpl" placeholder="文章模板">
							 </div>
							 <br>
