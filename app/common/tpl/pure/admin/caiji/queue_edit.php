...
{%block@main%}
<div class="path">
    <a href="<?=url('admin/index/index')?>">首页</a> > 采集设置 > <a href="<?=url('admin/caiji/queue')?>">队列管理</a> > <?=$title?>
</div>
                    ...
                    <form class="pure-form pure-form-stacked" action="" method="post">
                        <fieldset>
                            <div class="tab-item" id="category-main">
                                ...
                                <label for="callback">回调函数或方法<span class="red"> *</span>：支持格式：函数名，类名::静态方法名，类名@非静态方法名，类名必须带完整命名空间</label>
                                <input id="callback" class="pure-u-5-6" type="text" name="callback" value="<?=$data['callback']?>" placeholder="回调函数或方法" required>
