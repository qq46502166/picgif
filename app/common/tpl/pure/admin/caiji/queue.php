...
{%block@main%}
<div class="path">
    <a href="<?=url('admin/index/index')?>">首页</a> > 采集设置 > <?=$title?>
</div>
<div class="content">
        ...
        <div class="content-detail">
            <div class="content-button">
                <div class="content-top">
                    <a href="<?=url('admin/caiji/queue_add')?>" class="pure-button btn-custom btn-sm">添加定时</a><br><br>
                </div>
            </div>
                ...
                <form class="pure-form search-form mb-8" method="get">
                    <div class="dh-dropdown">
                        ...
                        <ul class="dh-dropdown-content delete-dropdown-content">
                            <li class="dh-dropdown-item delete-all"><a href="<?=url('admin/caiji/queue_del')?>">删除</a></li>
                        </ul>
                    </div>
                </form>
                    ...
                    <table class="full pure-table pure-table-bordered">
                        ...
                        <?php  foreach ($data as $item):?>
                            <tr>
                                ...
                                <td align="center">
                                    <a class="pure-button btn-success btn-xs edit" href="/admin/caiji/queue_edit.html?id=<?=$item['id']?>">编辑</a>
                                </td>
                            </tr>
                        <?php endforeach;?>
                        </tbody>
