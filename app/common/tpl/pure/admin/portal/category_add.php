						 ...
						 <div class="tab-item" id="category-main">
							...
							<textarea id="description" name="description" class="pure-input-1-2"></textarea>
							 ...
							 <div class="tab-item" id="category-seo">
								...
								<textarea class="pure-input-1-2" id="seo_description" name="seo_description" rows="3" placeholder="SEO描述"></textarea>
							 </div>
...
$(function(){
	$("#admin-portal-category_add-<?=$type?>").addClass('active-this');
	Jtab('#jtab');
	showMsg('.msg');
