							...
							<textarea id="description" name="description" class="pure-input-1-2"><?=$category['description']?></textarea>
							 ...
							 <div class="tab-item" id="category-seo">
								...
								<label for="seo_description">SEO描述（最多255个字）</label>
								 <textarea class="pure-input-1-2" id="seo_description" name="seo_description" rows="3"><?=$category['seo_description']?></textarea>
							 </div>
							 <div class="tab-item" id="category-tpl">
								...
								<input class="pure-input-1-2" value="<?=$category['content_tpl']?>" id="content_tpl" type="text" name="content_tpl" placeholder="文章模板">
							 </div>
