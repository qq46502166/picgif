...
<?php if($comments): foreach ($comments as $comment):?>
    <li class="comment-list-item" id="comment-<?=$comment['id'];?>">
        <div class="comment-list-img">
            <a href="javascript:;">
                <?php echo $comment['avatar'] ? '<img src="'.$comment['avatar'].'" alt="'.$comment['username'].'">' : '<img src="/uploads/user/default.png" alt="">';?>
            </a>
        </div>
        <div class="comment-list-body">
            <div class="comment-list-info">
                <a class="comment-list-user" href="javascript:;" id="user-<?=$comment['id']?>"><?=$comment['username']?></a>
            ...
            <div class="comment-list-children">
                <?php if($comment['children'] >0 ):
                    ...
                    $children=$cmModel->getSome(['pid'=>$comment['id']],10);
                    if($children):?>
                        <ul>
