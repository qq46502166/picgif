    ...
    public function request($url,$method='get',$data=array()){
        ...
        switch ($method){
            ...
            case 'put':
                ...
                if(isset($data[CURLOPT_INFILE])){
                    $this->options[CURLOPT_INFILE]=fopen($data[CURLOPT_INFILE], 'rb');
                    $this->options[CURLOPT_INFILESIZE]=filesize($data[CURLOPT_INFILE]);
                    unset($data[CURLOPT_INFILE]);
                }
